...
%-------------------------------------------
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{As a Technical Account Manager, I was responsible for managing and supporting the technical needs of clients using Huawei Cloud services.}
